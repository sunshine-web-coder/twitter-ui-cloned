              ...
              <div className={SideBarStyle.inner_dhui88}>
                ...
                <div className={SideBarStyle.separator}></div>
                  <div className={SideBarStyle.bottom}>
                    ...
                    <li><Link className={SideBarStyle.sideLinks} to="/">Log out @Yearst1</Link></li>
                  </div>
              </div>
            </div>
